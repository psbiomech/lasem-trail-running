...
# failedfiles = c3dex.c3d_batch_process(user, traildb, lasem, 2, get_analog=True, restart="TRAIL483")
...
failedfiles = osr.export_opensim_results_subject_mean(traildb, user, ["ik", "id", "emg"], 101)
